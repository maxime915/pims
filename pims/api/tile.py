...
def show_normalized_tile(filepath, zoom=None, level=None, ti=None, tx=None, ty=None,
                         channels=None, z_slices=None, timepoints=None,
                         c_reduction="ADD", z_reduction=None, t_reduction=None,
                         min_intensities=None, max_intensities=None, colormaps=None, filters=None,
                         gammas=None, log=None):
...
def show_normalized_tile_by_zoom(filepath, zoom, ti, channels=None, z_slices=None, timepoints=None,
                                 c_reduction="ADD", z_reduction=None, t_reduction=None,
                                 min_intensities=None, max_intensities=None, colormaps=None, filters=None,
                                 gammas=None, log=None):
    return show_normalized_tile(filepath, zoom=zoom, ti=ti, channels=channels, z_slices=z_slices, timepoints=timepoints,
                                c_reduction=c_reduction, z_reduction=z_reduction, t_reduction=t_reduction,
                                min_intensities=min_intensities, max_intensities=max_intensities, colormaps=colormaps,
                                filters=filters, gammas=gammas, log=log)


def show_normalized_tile_with_body_by_zoom(filepath, zoom, ti, body):
    return show_normalized_tile_by_zoom(filepath, zoom, ti, **body)


def show_normalized_tile_by_level(filepath, level, ti, channels=None, z_slices=None, timepoints=None,
                                  c_reduction="ADD", z_reduction=None, t_reduction=None,
                                  min_intensities=None, max_intensities=None, colormaps=None, filters=None,
                                  gammas=None, log=None):
    return show_normalized_tile(filepath, level=level, ti=ti, channels=channels, z_slices=z_slices,
...
def show_normalized_tile_with_body_by_level(filepath, level, ti, body):
    return show_normalized_tile_by_level(filepath, level, ti, **body)


def show_normalized_tile_with_body(filepath, body):
